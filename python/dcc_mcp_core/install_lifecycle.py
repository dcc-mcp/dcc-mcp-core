...
def resolve_deployment_layout(
    ...
    *,
    ...
    Rez deployments should call this from bootstrap scripts after resolving
    packages. Explicit roots win, followed by ``REZ_<PACKAGE>_ROOT`` variables
    and then an optional caller-provided cache root.
    """
...
if __name__ == "__main__":
    from dcc_mcp_core.install_lifecycle_cli import main
