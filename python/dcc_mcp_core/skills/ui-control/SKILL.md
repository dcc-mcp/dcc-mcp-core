...
metadata:
  dcc-mcp:
    ...
    search-hint: "dcc ui control, cua, ui automation, chrome cdp, edge cdp, screenshot, click, type, keypress, scroll, wait, trajectory recording"
    tags: "ui-control, cua, ui-automation, chrome-cdp, diagnostics, infrastructure"
    tools: tools.yaml
---
...
keyboard input also require `DCC_MCP_CUA_ALLOW_RAW_INPUT=true`; semantic
accessibility actions remain preferred.
