...
_uia_spec = importlib.util.spec_from_file_location("_uia_script", Path(__file__).parent / "_uia_script.py")
_uia_module = importlib.util.module_from_spec(_uia_spec)
_uia_spec.loader.exec_module(_uia_module)
_UIA_SCRIPT = _uia_module._UIA_SCRIPT
