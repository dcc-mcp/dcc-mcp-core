...
## [0.18.0](https://github.com/dcc-mcp/dcc-mcp-core/compare/v0.18.38...v0.18.0) (2026-06-23)


### Features

* add --restart flag to dcc-mcp-server gateway daemon ([fa46bb0](https://github.com/dcc-mcp/dcc-mcp-core/commit/fa46bb02aba71c65527c17c26b40f42800c2466e))
* add admin memory management ([024705c](https://github.com/dcc-mcp/dcc-mcp-core/commit/024705c219b8a511863a5212d318141def7c23d4))
* add asset-source skill and demo docs for cross-DCC asset import (PIP-1833) ([c9df0bf](https://github.com/dcc-mcp/dcc-mcp-core/commit/c9df0bff15381e971f188e4b80486ba972c238d1))
* add CLI standalone ZIP bundle and update manifest to release pipeline ([7099ef8](https://github.com/dcc-mcp/dcc-mcp-core/commit/7099ef857e3788aaf1a4559f00a5a5e0181d1cc5))
* add HTTP instance registration ([82e025c](https://github.com/dcc-mcp/dcc-mcp-core/commit/82e025cea6459126c2b57357e3c697cbd4d2dc21)), closes [#1361](https://github.com/dcc-mcp/dcc-mcp-core/issues/1361)
* add import-light sidecar launch helper ([27913ff](https://github.com/dcc-mcp/dcc-mcp-core/commit/27913ff9d1f18292913a17c984c7bb918137a21e))
* add marketplace-create-extension and formalize publish-extension skills ([#1564](https://github.com/dcc-mcp/dcc-mcp-core/issues/1564)) ([7427ba0](https://github.com/dcc-mcp/dcc-mcp-core/commit/7427ba0d579cea8c126192726d13236ebffcea02))
* add optional mDNS instance discovery ([3dcfc1d](https://github.com/dcc-mcp/dcc-mcp-core/commit/3dcfc1db0e054b3a7eaf1173bb017d213fb489ff))
* add relay-backed gateway discovery ([#1385](https://github.com/dcc-mcp/dcc-mcp-core/issues/1385)) ([a7ee593](https://github.com/dcc-mcp/dcc-mcp-core/commit/a7ee5932cfd0a02bb18fd57b5e0ec4be5312f82e))
* add server release bundles ([70dde08](https://github.com/dcc-mcp/dcc-mcp-core/commit/70dde08b919678bd3bb346c14983f484a75d2808))
* **admin-ui:** add integrations panel ([06c65d8](https://github.com/dcc-mcp/dcc-mcp-core/commit/06c65d842749ad326f824a534bcbbff0a6d531b1))
* **admin-ui:** add marketplace detail modal and platform module ([504f2b6](https://github.com/dcc-mcp/dcc-mcp-core/commit/504f2b6fce39ae8062521833b9b6c3f19a2c461e))
* **admin-ui:** add Marketplace panel with per-DCC install/uninstall ([3694183](https://github.com/dcc-mcp/dcc-mcp-core/commit/369418337cf059bb47f842b8cff6e16d23958876))
* **admin-ui:** add marketplace Playwright E2E test specs ([4fa33dc](https://github.com/dcc-mcp/dcc-mcp-core/commit/4fa33dc9bc777fa4c0fccecf6f870dc85ddaf322))
* **admin-ui:** add marketplace source management, update flow, force install, and structured error display ([3aa5683](https://github.com/dcc-mcp/dcc-mcp-core/commit/3aa56833b8702b5180ac4dd45983549a65091203))
* **admin-ui:** add Panel type extension, URL alias infrastructure, and tab query readers ([fdba051](https://github.com/dcc-mcp/dcc-mcp-core/commit/fdba0518400c070f1775367bf22c4a3ed1b01ef5))
* **admin-ui:** default to dark scheme, unify accent colors, add responsive nav ([499b815](https://github.com/dcc-mcp/dcc-mcp-core/commit/499b815fa8f9ea7211202432e3110f052f4099ef))
* **admin-ui:** equal-height skill cards + light/dark theme switcher ([1023142](https://github.com/dcc-mcp/dcc-mcp-core/commit/1023142d9eb1ad507a9718b35b91d2d7b5da807c))
* **admin-ui:** marketplace skill cards with branding, links, and modal drill-down ([bbd9438](https://github.com/dcc-mcp/dcc-mcp-core/commit/bbd9438a4c72dd8c8ca513fe774c15e358e09311))
* **admin-ui:** Phase 1 panel consolidation — Discover/Overview/Traces sub-tabs ([830be6c](https://github.com/dcc-mcp/dcc-mcp-core/commit/830be6cbc3d4757b4d1cc5478aa52a99faafcacf))
* **admin-ui:** TokenTracker-style redesign + richer stats/workflow/task metrics ([7431e6c](https://github.com/dcc-mcp/dcc-mcp-core/commit/7431e6c38d6c621342c020b8f22a8924581ef1b8))
* **admin:** add P1 analytics dashboard with daily aggregation API ([3f7d536](https://github.com/dcc-mcp/dcc-mcp-core/commit/3f7d5365ad4326bf6ffd5e882394ac333f070ea2))
* **admin:** refresh dcc mcp logo ([d0b88c9](https://github.com/dcc-mcp/dcc-mcp-core/commit/d0b88c90832dad4df77a53950336921d3beeff23))
* **admin:** slide-out detail panel for installed marketplace packages ([35aceb3](https://github.com/dcc-mcp/dcc-mcp-core/commit/35aceb35f4689b58ba982e05df3738102896816a))
* **brand:** refresh DCC MCP logo ([2dbca4e](https://github.com/dcc-mcp/dcc-mcp-core/commit/2dbca4e0389b4acbb6c7402688ce28dea3c6a899))
* **catalog:** add dcc-mcp-maya-mgear entry ([8809073](https://github.com/dcc-mcp/dcc-mcp-core/commit/8809073fb373b319be422b2cfbcbcd564a867461))
* **catalog:** extend install schema with pip package support ([92d372b](https://github.com/dcc-mcp/dcc-mcp-core/commit/92d372be7b87280cc975592a3556e8888ac41ad6))
* **ci:** add macOS cp37 wheel via Rosetta 2 cross-compilation ([bc0b6f2](https://github.com/dcc-mcp/dcc-mcp-core/commit/bc0b6f2ae7b9b100ce5061bb1c3226f2c42d67eb))
* **cli:** add `gateway ensure|start|stop|status` lifecycle commands ([3fb827e](https://github.com/dcc-mcp/dcc-mcp-core/commit/3fb827ea461d95597d1a55fbced40f15f35384bb))
* **cli:** add local-first gateway control ([2d283a3](https://github.com/dcc-mcp/dcc-mcp-core/commit/2d283a34ee0b03cd06f2facc0dc6263f07536d36))
* **cli:** add marketplace catalog discovery ([0391b88](https://github.com/dcc-mcp/dcc-mcp-core/commit/0391b883b0f777b0b131c11c7d2e2a7727979863))
* **cli:** implement install --execute with consent gating and rollback ([db5c6dd](https://github.com/dcc-mcp/dcc-mcp-core/commit/db5c6ddf7f58adf48ebc1d0c602930917e74f53a))
* **cli:** implement install --execute with InstallStepAction, consent gating, and rollback ([4806f5a](https://github.com/dcc-mcp/dcc-mcp-core/commit/4806f5a12380eed5837027e963daad66d52303d0))
* **cli:** implement three-layer gateway binary discovery ([c85a5a2](https://github.com/dcc-mcp/dcc-mcp-core/commit/c85a5a22a2f7d7b64843cc2abdba00d4233c6519))
* **cli:** install marketplace skill packages ([805dc8a](https://github.com/dcc-mcp/dcc-mcp-core/commit/805dc8a4093b1fc7411795d48fe0cb4b3f7bb934))
* **core:** add exception protection and watchdog for gateway guardian ([766b56e](https://github.com/dcc-mcp/dcc-mcp-core/commit/766b56e62ce93f8bd311b4cadf9d8b0d9021c2d9))
* **core:** add watchdog for Rust gateway guardian in sidecar ([f6d1c89](https://github.com/dcc-mcp/dcc-mcp-core/commit/f6d1c899765437696ebcac55f0b799a65e03cbf5))
* **core:** extract shared registration phase pipeline from Maya adapter ([c505a78](https://github.com/dcc-mcp/dcc-mcp-core/commit/c505a78532f9ee852d1beffea53230e8bff65886))
* **daemon:** refactor gateway guardian to use launch_detached, add build_gateway_daemon_command ([#1509](https://github.com/dcc-mcp/dcc-mcp-core/issues/1509)) ([d171990](https://github.com/dcc-mcp/dcc-mcp-core/commit/d1719907d21334525bd389febaf33513a47080ba))
* **dcc-mcp-updater, gateway, cli, server:** add gateway-controlled auto-update mechanism ([53c0fc7](https://github.com/dcc-mcp/dcc-mcp-core/commit/53c0fc7b9e4ce5a93c0a31c1aaea001c8fab776c))
* **diagnostics:** add dcc_diagnostics__gateway_failover tool ([#1355](https://github.com/dcc-mcp/dcc-mcp-core/issues/1355)) ([d96bd2a](https://github.com/dcc-mcp/dcc-mcp-core/commit/d96bd2aa86c3f7b25bf67592da38154bded8fa8a))
* dispatch lifecycle hooks from public APIs ([bcc9eda](https://github.com/dcc-mcp/dcc-mcp-core/commit/bcc9eda418bd4b4c973f36f27c772e0738a9425a)), closes [#1337](https://github.com/dcc-mcp/dcc-mcp-core/issues/1337)
* extract shared dcc-mcp-marketplace crate ([#1537](https://github.com/dcc-mcp/dcc-mcp-core/issues/1537)) ([f75a9c6](https://github.com/dcc-mcp/dcc-mcp-core/commit/f75a9c6699e4fe5f624a6a4a1f0136e57d757cd3))
* extract shared gateway ensure crate ([1c53c8a](https://github.com/dcc-mcp/dcc-mcp-core/commit/1c53c8ab70d4e86cda4aa54caab42935d83d9447))
* **gateway:** add _meta passthrough to adapter skill params + marketplace admin API endpoints ([08a7f5b](https://github.com/dcc-mcp/dcc-mcp-core/commit/08a7f5b838a7dc3b6d56909cacdb64a7581df7ef))
* **gateway:** add daemon mode support for gateway server and Python API ([a43d8c8](https://github.com/dcc-mcp/dcc-mcp-core/commit/a43d8c80718af18443a4ee18dc72298c6ba67409))
* **gateway:** add dcc_types[] + tags_any OR filters to search ([3f7073e](https://github.com/dcc-mcp/dcc-mcp-core/commit/3f7073ee0acc0a9447b67eeddfc1e7c0bc09127e))
* **gateway:** add idle lifecycle policy ([0c699d8](https://github.com/dcc-mcp/dcc-mcp-core/commit/0c699d8c07d5656f49288ed157427c18f38136cf))
* **gateway:** add LLM usage header support and token visibility plumbing ([9c97e7d](https://github.com/dcc-mcp/dcc-mcp-core/commit/9c97e7d94bf3b58ec8893d8cf36fb699c2d7b8a1))
* **gateway:** add status tracking and handle to Rust gateway guardian ([d9ea1c9](https://github.com/dcc-mcp/dcc-mcp-core/commit/d9ea1c998c9affe1fb05286bd5d4ce8a6446c660))
* **gateway:** enforce bearer-token auth and per-token DCC scope on registration plane ([dbfae9d](https://github.com/dcc-mcp/dcc-mcp-core/commit/dbfae9d9b5932c7dba00104490fe6c56d435cde2))
* **gateway:** expose dispatch readiness in instances ([9d4f3d2](https://github.com/dcc-mcp/dcc-mcp-core/commit/9d4f3d238f47cfd57fdff0b785575e3461658665))
* **gateway:** expose dispatch readiness in readyz ([ee762a6](https://github.com/dcc-mcp/dcc-mcp-core/commit/ee762a6b6e508bb9750501822ecf5e60134d61cd))
* **gateway:** expose progressive tool-group active state in capability search ([81b8028](https://github.com/dcc-mcp/dcc-mcp-core/commit/81b80288111a587780500cf4073fd91369a54205))
* **gateway:** expose recovery diagnostics ([9e32a93](https://github.com/dcc-mcp/dcc-mcp-core/commit/9e32a93ae1061d131965a1fd42b3d75b04156e44))
* **gateway:** optimize PIP-577 discovery workflow ([ae3524a](https://github.com/dcc-mcp/dcc-mcp-core/commit/ae3524ad92e002e3d56ee5ad6d4b2e810c1aeb3e))
* **gateway:** passthrough bounded request meta ([4d9a0de](https://github.com/dcc-mcp/dcc-mcp-core/commit/4d9a0de7fc89c2d1927891cec60588d4efe37b44))
* **gateway:** publish guardian watchdog status to sidecar registry metadata ([72c5ec2](https://github.com/dcc-mcp/dcc-mcp-core/commit/72c5ec2cafe9a621c750b01bd453a28f477e7da6))
* **gateway:** publish live guardian metadata ([8fc57e1](https://github.com/dcc-mcp/dcc-mcp-core/commit/8fc57e196ad0a1d48ea2f600a94ee4f2cee73786))
* **gateway:** support calls[] batch on REST /v1/call ([2a9fc64](https://github.com/dcc-mcp/dcc-mcp-core/commit/2a9fc647d1e4975bcc97fa564b1ef509faa70f41))
* **gateway:** wire gateway ensure into Python DccServerBase default startup ([2c65800](https://github.com/dcc-mcp/dcc-mcp-core/commit/2c65800a9cf40a5d42ec543bf9951e47b152ef63))
* implement asset_import contract module (GH-1698) ([ac70f3c](https://github.com/dcc-mcp/dcc-mcp-core/commit/ac70f3c965e686142022584cf4e1ee0e04554a46))
* improve admin control plane ([7ffa0f5](https://github.com/dcc-mcp/dcc-mcp-core/commit/7ffa0f550f4cf19515cec1548b0cca6b200aa960))
* inject bounded agent memory summaries ([ae3c1a3](https://github.com/dcc-mcp/dcc-mcp-core/commit/ae3c1a342b7dd25b30302568092462d10c7998bc)), closes [#1334](https://github.com/dcc-mcp/dcc-mcp-core/issues/1334)
* **install:** classify sidecar dispatch capability ([543b6aa](https://github.com/dcc-mcp/dcc-mcp-core/commit/543b6aaa50fbe1dc59db53b74bcf6dda386d1a1a))
* **install:** expose sidecar dispatch contract ([3ca6faa](https://github.com/dcc-mcp/dcc-mcp-core/commit/3ca6faa00b94e178df9437d76dde008b941d4164))
* **marketplace:** add add-repo command for direct GitHub install (PIP-1377) ([46d9ecb](https://github.com/dcc-mcp/dcc-mcp-core/commit/46d9ecb982e83f32bd2dc854d0b0143225e7fa13))
* **marketplace:** add icon field to CatalogEntry and admin UI cards ([7312dd4](https://github.com/dcc-mcp/dcc-mcp-core/commit/7312dd47b02f19bf5c94becae5ec94eaf02362e2))
* **marketplace:** add update/outdated commands and migrate gateway catalog ([e93421e](https://github.com/dcc-mcp/dcc-mcp-core/commit/e93421e1d701cbae94a76d9de4f7a7f3cb225379))
* **marketplace:** CLI read-only commands with schema validation and multi-source merge ([08af31a](https://github.com/dcc-mcp/dcc-mcp-core/commit/08af31a05a6c1548c6a93f12759cde8e36d58b80))
* **marketplace:** install zip skill packages ([3a32348](https://github.com/dcc-mcp/dcc-mcp-core/commit/3a32348a1172b6e5e0b68efcc3f2b2ccea3ae60e))
* **models:** add call_examples to describe responses ([cfb01cc](https://github.com/dcc-mcp/dcc-mcp-core/commit/cfb01cc3c8bfa9fd2e060fa0bf9f37e92e0c451a))
* **qt-ui-inspector:** expose as default capability via register_qt_ui_inspector ([#1332](https://github.com/dcc-mcp/dcc-mcp-core/issues/1332)) ([2235d0a](https://github.com/dcc-mcp/dcc-mcp-core/commit/2235d0ad07996437660052b03f2db20614a53029))
* reduce gateway guardian watchdog interval from 60s to 15s with immediate retry ([8147fc2](https://github.com/dcc-mcp/dcc-mcp-core/commit/8147fc287ffa099e794a2ab154eff722664c7398))
* **semantic:** add VectorSkillIndex with zero-dep default + optional ONNX extra ([#1393](https://github.com/dcc-mcp/dcc-mcp-core/issues/1393)) ([e4dea1b](https://github.com/dcc-mcp/dcc-mcp-core/commit/e4dea1b1f61e292caaaff7cf1ca01ffb26031153))
* **semantic:** native Rust embeddings via fastembed-rs as opt-in companion ([#1395](https://github.com/dcc-mcp/dcc-mcp-core/issues/1395)) ([3f4bb49](https://github.com/dcc-mcp/dcc-mcp-core/commit/3f4bb49fa334eab541e8ec593840cc9624c1f2a2))
* **semantic:** wire OnnxEmbedder to fastembed with env-var model loading ([#1393](https://github.com/dcc-mcp/dcc-mcp-core/issues/1393)) ([12953c1](https://github.com/dcc-mcp/dcc-mcp-core/commit/12953c17e49ab74e2e0822d3fc7cbb9d3c5e74c6))
* **server:** add Sentry real-ingest E2E tests and CI job ([73a4934](https://github.com/dcc-mcp/dcc-mcp-core/commit/73a49345ea446126f0191c621bdd59db958971f1))
* **server:** ensure Python adapters start gateway daemon ([8ceca7c](https://github.com/dcc-mcp/dcc-mcp-core/commit/8ceca7c674d90f0c01286fd665bd2ef9bb03720a))
* **server:** ensure standalone gateway by default ([6ab446c](https://github.com/dcc-mcp/dcc-mcp-core/commit/6ab446c51986ce37713d7672f25823b90efac8a5))
* **server:** incorporate default built-in skills and unify registration ([#1332](https://github.com/dcc-mcp/dcc-mcp-core/issues/1332))\n\nPromotes infrastructure tools to first-class built-ins registered\nautomatically by DccServerBase.\n\n* New module dcc_mcp_core.skills.builtin: centralizes registration\n  of diagnostics, introspect, feedback, recipes, and qt-ui-inspector.\n* DccServerBase registers these in-process tools during __init__,\n  ensuring they are always available and highly efficient.\n* qt-ui-inspector moved to dcc_mcp_core.skills and added as a\n  bundled SKILL.md package for discovery.\n* dcc_server.py diagnostic tools unified under dcc_diagnostics__ prefix.\n* Redundant registration logic removed from ServerRuntimeController.\n* Deduplication handled via idempotent ToolRegistry and path filtering\n  in collect_skill_search_paths. ([f91261d](https://github.com/dcc-mcp/dcc-mcp-core/commit/f91261dad12a4e0ce9a0de7cd7e3e54f7e3ff39b))
* **server:** pick up admin-UI-added skill paths without restart ([#1400](https://github.com/dcc-mcp/dcc-mcp-core/issues/1400)) ([9642f02](https://github.com/dcc-mcp/dcc-mcp-core/commit/9642f02f906c4ec88ed174232c8cb98dacc4c4f3))
* **server:** publish gateway guardian metadata ([5c8260a](https://github.com/dcc-mcp/dcc-mcp-core/commit/5c8260a2e689b580bd91f1cb8f808d4c50d1d2e1))
* **server:** Sentry error monitoring and webhook analytics documentation ([f25adb6](https://github.com/dcc-mcp/dcc-mcp-core/commit/f25adb604b7f9a732756ebec95414bb6d5713bc9))
* sidecar health-aware gateway launch with version-aware election takeover ([e1cc94d](https://github.com/dcc-mcp/dcc-mcp-core/commit/e1cc94dab3ea9e46c9ef30a7c32906b8d0fa3101))
* **sidecar:** add launch readiness contract ([b3812b9](https://github.com/dcc-mcp/dcc-mcp-core/commit/b3812b986f3611c39ef9a1b94a3b2e960b4dd2d2))
* **sidecar:** reconnect delayed host rpc ([3926b7b](https://github.com/dcc-mcp/dcc-mcp-core/commit/3926b7b6418ae4d490384923bd06fe93823364a6))
* **sidecar:** surface gateway guardian mode ([c4c4f90](https://github.com/dcc-mcp/dcc-mcp-core/commit/c4c4f906614f0532580e018677ca5efc7021e5ec))
* **skill-rest:** surface next-tools at describe-time ([e39bfc6](https://github.com/dcc-mcp/dcc-mcp-core/commit/e39bfc63208a5958bee0bf9b0b15ebb2cf7f60c6)), closes [#1408](https://github.com/dcc-mcp/dcc-mcp-core/issues/1408)
* **skill:** qt-ui-inspector skill for DCC-agnostic Qt introspection ([#1332](https://github.com/dcc-mcp/dcc-mcp-core/issues/1332)) ([b3996a1](https://github.com/dcc-mcp/dcc-mcp-core/commit/b3996a1cfb4cdaa0b766ee9c5d5aec4aa4ef249c))
* **skills:** add marketplace-publish-extension skill package ([2761ad4](https://github.com/dcc-mcp/dcc-mcp-core/commit/2761ad47e0dce6a8f8094ffd546c318de02da8f0))
* **skills:** add marketplace-publish-extension skill package ([0387b97](https://github.com/dcc-mcp/dcc-mcp-core/commit/0387b97c314006b97d67bba7dab93d1adf0099ad))
* **skills:** add marketplace-publish-extension skill package ([9f41da7](https://github.com/dcc-mcp/dcc-mcp-core/commit/9f41da70ecbb00a487a67ffc51dbc5e8d2ffaa22))
* **skills:** add marketplace-publish-extension skill package ([c220882](https://github.com/dcc-mcp/dcc-mcp-core/commit/c220882bb11b8a0c8563c6cdeb3b9b900c48aac2))
* **skills:** de-prioritise infrastructure / example layers in search ([#1398](https://github.com/dcc-mcp/dcc-mcp-core/issues/1398)) ([9138458](https://github.com/dcc-mcp/dcc-mcp-core/commit/91384587970056a7dafb8e91dd6b62f0e1d8e48b))
* **skills:** formalize marketplace-create-extension and marketplace-publish-extension to skills/ ([d4d87ee](https://github.com/dcc-mcp/dcc-mcp-core/commit/d4d87eefb621605b090f6af7e26e7a77b796d97e))
* **skills:** formalize marketplace-create-extension and marketplace-publish-extension to skills/ ([fc27503](https://github.com/dcc-mcp/dcc-mcp-core/commit/fc27503543d02b1cfd4cb207206010a5511eeabb))
* **skills:** formalize marketplace-create-extension and marketplace-publish-extension to skills/ ([e1e92d5](https://github.com/dcc-mcp/dcc-mcp-core/commit/e1e92d5186bc82df7b2ed74808a5cf59bed39791))
* **skills:** formalize marketplace-create-extension and marketplace-publish-extension to skills/ ([6849396](https://github.com/dcc-mcp/dcc-mcp-core/commit/6849396901a865f862bd59f2d58b5978e368ad05))
* **skills:** integrate gateway ensure into dcc-cli-gateway skill ([72459eb](https://github.com/dcc-mcp/dcc-mcp-core/commit/72459eb0afaa3ab504249b8253e7f1c4a4aa19cc))
* **skills:** persist loaded skills + active groups across restarts ([#1405](https://github.com/dcc-mcp/dcc-mcp-core/issues/1405)) ([c280423](https://github.com/dcc-mcp/dcc-mcp-core/commit/c2804232d01080ddda677446d040e7aca60e508e))
* **skills:** rank user-curated skill paths above bundled material ([#1403](https://github.com/dcc-mcp/dcc-mcp-core/issues/1403)) ([a165275](https://github.com/dcc-mcp/dcc-mcp-core/commit/a165275d36f7b90fbdd14e8f55acbdd48c72535d))
* unify gateway instance source metadata ([#1386](https://github.com/dcc-mcp/dcc-mcp-core/issues/1386)) ([d842cad](https://github.com/dcc-mcp/dcc-mcp-core/commit/d842cad4fd857af58a0a6ee8ae4c933354e4f71f))


### Bug Fixes

* accept **kwargs in infra skill wrappers for in-process execution ([619d9ab](https://github.com/dcc-mcp/dcc-mcp-core/commit/619d9ab482d392f8293566b7c5d3f025a567649a))
* add CREATE_NO_WINDOW to subprocess calls that spawn console-subsystem binaries ([c6b9778](https://github.com/dcc-mcp/dcc-mcp-core/commit/c6b97788f3bcaf1944a355973a45eb31969e6595))
* add icon field to CatalogEntry for compatibility with feat/marketplace-icon ([2275ab7](https://github.com/dcc-mcp/dcc-mcp-core/commit/2275ab74f3319a855992251a1d58fa583119b1b9))
* **admin-ui:** replace isLoading with isPending for mutation result ([41bcd85](https://github.com/dcc-mcp/dcc-mcp-core/commit/41bcd85314e421b78ae5d365e7b4623a18a177d3))
* **admin-ui:** resolve TypeScript errors in panel consolidation ([301de08](https://github.com/dcc-mcp/dcc-mcp-core/commit/301de0851b58a19683a09b80d4a85e43901bddd0))
* **admin-ui:** switch lockfile from Tencent mirror to npmjs.org registry ([ab40e28](https://github.com/dcc-mcp/dcc-mcp-core/commit/ab40e28a9000d8ebb47d1304f3d7ed689a047e0c))
* **admin-ui:** use npmjs.org for style-to-object to avoid Tencent mirror 404 ([14d5f41](https://github.com/dcc-mcp/dcc-mcp-core/commit/14d5f418ca89da0acd6703be254d9d06a3d81a37))
* **admin-ui:** wire refresh buttons to query refetch, fix i18n key and unused imports ([4841b09](https://github.com/dcc-mcp/dcc-mcp-core/commit/4841b09132d7340d0c39f0d7c111de18fdc9e1e8))
* **admin:** expose sidecar dispatch state ([f61f98a](https://github.com/dcc-mcp/dcc-mcp-core/commit/f61f98a69086439377b905bc2ffe307a51576383))
* **admin:** green CI rust tests + split styles.css under size cap ([5088a68](https://github.com/dcc-mcp/dcc-mcp-core/commit/5088a684c11bc37156baeb4ca2fffecdbfe03926))
* align skill version diagnostics ([d7d8837](https://github.com/dcc-mcp/dcc-mcp-core/commit/d7d88372666dc37f9a510568e4e358fbc2527bbd))
* apply cargo fmt and ruff format for CI formatting checks ([125a13d](https://github.com/dcc-mcp/dcc-mcp-core/commit/125a13d20b5ce6b79ff14327ade73427d4a67b72))
* apply ruff format to generate_update_manifest.py ([49e8264](https://github.com/dcc-mcp/dcc-mcp-core/commit/49e8264f13b9c432f3d0187a8e354784001371f3))
* auto-ensure gateway for cli control ([04aaf95](https://github.com/dcc-mcp/dcc-mcp-core/commit/04aaf95af7bc978f331af3bed4def8bae11adb79))
* cache generated skill schemas ([0f59a07](https://github.com/dcc-mcp/dcc-mcp-core/commit/0f59a07346a97d6fa4e80f5fc626a0ad0ef69b49))
* cargo fmt --check compliance for discovery.rs ([2967f34](https://github.com/dcc-mcp/dcc-mcp-core/commit/2967f34fefd9a3acbbed58a9bcdb65e8f6e3d54f))
* cargo fmt formatting for gateway_discovery.rs ([1a209e5](https://github.com/dcc-mcp/dcc-mcp-core/commit/1a209e5426f105d8a4b8819924373eb30dc4a493))
* cargo fmt formatting for install.rs ([3787c8e](https://github.com/dcc-mcp/dcc-mcp-core/commit/3787c8ee75460f79d2273c67201b59b72e9b8b6c))
* cargo fmt formatting in skill_mgmt.rs and refresh.rs ([1fbc03c](https://github.com/dcc-mcp/dcc-mcp-core/commit/1fbc03c75520e651782c461d3b8e8a3a25b820d1))
* cargo fmt import ordering in buffer.rs ([3b21403](https://github.com/dcc-mcp/dcc-mcp-core/commit/3b2140318e9d61d8af9bc0572667c8e9a35cc79a))
* cargo fmt import ordering in capability/index.rs ([1aee9dd](https://github.com/dcc-mcp/dcc-mcp-core/commit/1aee9dde7c54255d932f15467bd3b91bde69676c))
* cargo fmt in tests.rs from regresion test commit ([a460afe](https://github.com/dcc-mcp/dcc-mcp-core/commit/a460afe0f2dacf061111d9d1b42e3678e5fde383))
* change default standalone registry DCC type from generic to python ([49d4cc8](https://github.com/dcc-mcp/dcc-mcp-core/commit/49d4cc83dfaac925f883b33ebad647f0e167befa))
* **ci, media:** add py314 coverage and portable ffmpeg flags ([b1f423b](https://github.com/dcc-mcp/dcc-mcp-core/commit/b1f423b3a2a5b67052226dd361eb1f29a49329d3))
* **ci:** add --include=optional to npm ci for rolldown native bindings ([6ce7a4b](https://github.com/dcc-mcp/dcc-mcp-core/commit/6ce7a4b71cc37d0d6ab01e1a301d1a7ddce3fc93))
* **ci:** add execute permission to build_manylinux_semantic_wheel.sh ([966e8c1](https://github.com/dcc-mcp/dcc-mcp-core/commit/966e8c1c28c9c164ec87c303e8dfae0f7377d9e4))
* **ci:** add npm ci retry in build-wheel action for transient network errors ([af23441](https://github.com/dcc-mcp/dcc-mcp-core/commit/af23441c6656a48ec22a6a97e5c3ded47c8c7a78))
* **ci:** add pull_request_target workflow for Sentry E2E on fork PRs ([a44b868](https://github.com/dcc-mcp/dcc-mcp-core/commit/a44b8685681a443425fcdd214d0b661d9c5fdece))
* **ci:** add retry with exponential backoff for Multica 429 in publish workflow ([d4ae03d](https://github.com/dcc-mcp/dcc-mcp-core/commit/d4ae03da16340db846b88303e7af5caf28319c3e))
* **ci:** explicitly install lightningcss native module after npm ci ([d0f37e1](https://github.com/dcc-mcp/dcc-mcp-core/commit/d0f37e19363972a8f4a6f43b720cd9be99427862))
* **ci:** increase release asset verification retries to 20 and add diagnostic logging ([35a397a](https://github.com/dcc-mcp/dcc-mcp-core/commit/35a397a455ac96c3882da6d00fc8d1afd7bfea3c))
* **ci:** install openssl-devel in manylinux semantic wheel build ([7520cc8](https://github.com/dcc-mcp/dcc-mcp-core/commit/7520cc882bbf5638b3114b16f585115663e688ae))
* **ci:** install openssl-devel in manylinux semantic wheel build ([7520cc8](https://github.com/dcc-mcp/dcc-mcp-core/commit/7520cc882bbf5638b3114b16f585115663e688ae))
* **ci:** install openssl-devel in manylinux semantic wheel build ([ac4ee10](https://github.com/dcc-mcp/dcc-mcp-core/commit/ac4ee104ee50ac0a5d4f8e0fdfe45b06c393d5a5))
* **ci:** install Windows Python 3.7 for release wheels ([#1520](https://github.com/dcc-mcp/dcc-mcp-core/issues/1520)) ([eaa6839](https://github.com/dcc-mcp/dcc-mcp-core/commit/eaa68394b1df755b38f97817ddba156a1b1fd6a5))
* **ci:** isolate workflow_dispatch from push concurrency in release workflow ([aafd1f8](https://github.com/dcc-mcp/dcc-mcp-core/commit/aafd1f8ed89084a0629ba3f59bdee8974de3f832))
* **ci:** override maturin docker entrypoint and bump vx to 0.9.11 ([92c85b5](https://github.com/dcc-mcp/dcc-mcp-core/commit/92c85b5f31973c266b96a1d42bfe331a94c3b2fe))
* **ci:** pin build-wheel windows runner to windows-2022 ([5d50036](https://github.com/dcc-mcp/dcc-mcp-core/commit/5d500365fb3e27670659fe3a511f54ce31e65858))
* **ci:** remove continue-on-error from reusable workflow job in release.yml ([f8aa45d](https://github.com/dcc-mcp/dcc-mcp-core/commit/f8aa45d95a987aab0f76509ad601d38cbb001389))
* **ci:** remove duplicate cargo-deny job definition ([0502292](https://github.com/dcc-mcp/dcc-mcp-core/commit/05022922d2ee35eb7fc3d27a44b1ba399577d9bf))
* **ci:** remove pull_request_target workflow for Sentry E2E on fork PRs ([#1535](https://github.com/dcc-mcp/dcc-mcp-core/issues/1535)) ([16620fe](https://github.com/dcc-mcp/dcc-mcp-core/commit/16620feb261cf8d13416fd4ecde5875fdb86c78b))
* **ci:** scope cancel-in-progress to push events only in release concurrency ([2632b3b](https://github.com/dcc-mcp/dcc-mcp-core/commit/2632b3b71cfeb3d94ab54cfa9f19e9bc1092ee1d))
* **ci:** set cancel-in-progress to true in release workflow concurrency ([b207369](https://github.com/dcc-mcp/dcc-mcp-core/commit/b2073693239813ccffa1d97157b42175de66c47f))
* **ci:** skip npm ci on macOS rust-check — use prebuilt admin UI artifact ([963cdd1](https://github.com/dcc-mcp/dcc-mcp-core/commit/963cdd1a4eb820f55fd5f1c798f5b02e082c27df))
* **ci:** unblock lint, stub-gen, and wheel-build for the qt-ui-inspector stack ([#1332](https://github.com/dcc-mcp/dcc-mcp-core/issues/1332)) ([2ffa215](https://github.com/dcc-mcp/dcc-mcp-core/commit/2ffa215ef2fe54f0c2e980197c46cfc0da7d5e25))
* **ci:** unblock v0.17.45 wheel builds and Rust coverage ([37a8327](https://github.com/dcc-mcp/dcc-mcp-core/commit/37a8327c8375d8f9971260d56932611e0ce7a849))
* **ci:** upload build-wheels artifacts directly to GitHub Release ([c5add04](https://github.com/dcc-mcp/dcc-mcp-core/commit/c5add040ecae98923b1f11f0a6cb63f001408d98))
* **ci:** use any() in release asset pattern matching to fix false timeout ([bce9505](https://github.com/dcc-mcp/dcc-mcp-core/commit/bce95057c897c165cc8505d433e8ef08b0c3b255))
* **ci:** use Python 3.7.9 macOS installer instead of 3.7.17 ([9d21b01](https://github.com/dcc-mcp/dcc-mcp-core/commit/9d21b013653e5728cab3c2dfff5691165986fa22))
* **cli, fmt, clippy:** fix lint errors and apply cargo fmt ([8de41cb](https://github.com/dcc-mcp/dcc-mcp-core/commit/8de41cb126c730a9dda19c2ec91aa9be8c1a25b9))
* **cli:** harden marketplace package installs ([00582a6](https://github.com/dcc-mcp/dcc-mcp-core/commit/00582a60bc0440015df0202ff963899d860a5640))
* clippy warnings for Rust 1.96 — needless_borrows_for_generic_args and let_and_return ([3ea9bc3](https://github.com/dcc-mcp/dcc-mcp-core/commit/3ea9bc3bdc59da23cb174e0fcf6ba6b38753c29d))
* collapse nested if-let in rollback_all (clippy::collapsible_if) ([9097246](https://github.com/dcc-mcp/dcc-mcp-core/commit/9097246ba229adf801bd2b6fcd52cf097d9e8f3a))
* **compat:** backport typing.Protocol for Python 3.7 wheel parity ([39627ba](https://github.com/dcc-mcp/dcc-mcp-core/commit/39627ba5cb1abbf1402238ad273e69cc9b587129))
* **core:** prevent YAML skill overwrite of builtin diagnostic tools ([#1703](https://github.com/dcc-mcp/dcc-mcp-core/issues/1703)) ([51cd858](https://github.com/dcc-mcp/dcc-mcp-core/commit/51cd85893741a8f186fd9181d47ae5ddb9ae5b53)), closes [#1696](https://github.com/dcc-mcp/dcc-mcp-core/issues/1696)
* **daemon:** address review feedback for PIP-513 daemon mode ([44c57b7](https://github.com/dcc-mcp/dcc-mcp-core/commit/44c57b741bf27c1b154019d4d413457985c573b5))
* **daemon:** harden gateway detach semantics ([937feca](https://github.com/dcc-mcp/dcc-mcp-core/commit/937fecafd745dfed0322f8cf4d1029a75a363737))
* deduplicate Qt dispatcher Python implementation ([1ccebcb](https://github.com/dcc-mcp/dcc-mcp-core/commit/1ccebcbc4ddfbc3f72c32f8910095353348d6f84))
* deduplicate schema-generation warnings to prevent log flooding ([#1700](https://github.com/dcc-mcp/dcc-mcp-core/issues/1700)) ([ded717b](https://github.com/dcc-mcp/dcc-mcp-core/commit/ded717bf5cb01b9a3b2c4c61d822013a42242274)), closes [#1695](https://github.com/dcc-mcp/dcc-mcp-core/issues/1695)
* disable gateway election for job persistence probe server ([0f894fd](https://github.com/dcc-mcp/dcc-mcp-core/commit/0f894fd6abdce9dc1dd20e37436cf263ec274620))
* ensure gateway before local cli list ([a7945ce](https://github.com/dcc-mcp/dcc-mcp-core/commit/a7945ce05d4782b86298cc2b1530e00ab751159a))
* fail fast for local workflow actions ([7b9b9e9](https://github.com/dcc-mcp/dcc-mcp-core/commit/7b9b9e965bb8bca434d6a6a6182c53b02445ef00))
* gate admin-only gateway code ([674bd8b](https://github.com/dcc-mcp/dcc-mcp-core/commit/674bd8b7e5dffbcb0a4b7801d83f9aa1f540b77a))
* **gateway-ensure:** collapse nested if to fix clippy collapsible_if ([15df44b](https://github.com/dcc-mcp/dcc-mcp-core/commit/15df44bb2f30876e9ceee4bf3f72110959dd28af))
* **gateway:** activate skill groups by default ([24fe7d0](https://github.com/dcc-mcp/dcc-mcp-core/commit/24fe7d056e4a3f410af1c9d5b52af05552e2ba1d))
* **gateway:** add abort_and_wait to GatewayHandle to prevent SIGABRT on shutdown ([6a1e7e8](https://github.com/dcc-mcp/dcc-mcp-core/commit/6a1e7e8639fd42ea2ef0a99b779f68ab1328f131))
* **gateway:** add abort_and_wait to GatewayHandle to prevent SIGABRT on shutdown ([ea198fa](https://github.com/dcc-mcp/dcc-mcp-core/commit/ea198faf082d4a99b70f8d72c4bbbc9ff080b33e))
* **gateway:** address review feedback on progressive group search ([5b05e5f](https://github.com/dcc-mcp/dcc-mcp-core/commit/5b05e5f72d684b7505f9c10d77d58ad4c8bee7d6))
* **gateway:** align daemon keepalive liveness ([427dabb](https://github.com/dcc-mcp/dcc-mcp-core/commit/427dabbc40496e91cc48f9383a1f63f4c5218cc5))
* **gateway:** evict host-died instances immediately ([aaa8328](https://github.com/dcc-mcp/dcc-mcp-core/commit/aaa8328576f1cee12dd0b1011cbe66894558a2e9))
* **gateway:** harden meta passthrough for CI ([ab30ab4](https://github.com/dcc-mcp/dcc-mcp-core/commit/ab30ab4d3b9196662fc75c62a650639971d2f2ce))
* **gateway:** ignore stale rows in fingerprints ([f6c3808](https://github.com/dcc-mcp/dcc-mcp-core/commit/f6c38086cf9a72f345fa1637ed06464655d65306))
* **gateway:** inject load_skill tools directly into capability index ([#1659](https://github.com/dcc-mcp/dcc-mcp-core/issues/1659)) ([ec5b41d](https://github.com/dcc-mcp/dcc-mcp-core/commit/ec5b41db20741c89a5ead96b2402bff06256566f))
* **gateway:** prevent discovery queries to dispatch-only sidecars ([f131936](https://github.com/dcc-mcp/dcc-mcp-core/commit/f1319360583a9ec111d941945feee4303872a375))
* **gateway:** project llm_usage into admin API rows and SQLite persistence ([920f464](https://github.com/dcc-mcp/dcc-mcp-core/commit/920f46471a143b1c742d94f29cd9c0847522826d))
* **gateway:** reject ambiguous instance resource prefixes ([8926342](https://github.com/dcc-mcp/dcc-mcp-core/commit/8926342c04fada1842c0ca848a35d407a9f675cd))
* **gateway:** restructure _LaunchLock.acquire to reduce TOCTOU windows ([1ada471](https://github.com/dcc-mcp/dcc-mcp-core/commit/1ada4710fab6c03c5d6f11eae483fdc111a7aa3d))
* **gateway:** route skill lifecycle dispatch through MCP URL when discovery URL is missing ([#1701](https://github.com/dcc-mcp/dcc-mcp-core/issues/1701)) ([82d3d84](https://github.com/dcc-mcp/dcc-mcp-core/commit/82d3d847750f347de6916a6f6828ccaae561e8ed))
* **gateway:** summarize daemon recovery readiness ([60249f5](https://github.com/dcc-mcp/dcc-mcp-core/commit/60249f5230d30fad42b4536805448983c925e7b3))
* **gateway:** update admin HTML test to match @tanstack/query template literal URL ([9becdfa](https://github.com/dcc-mcp/dcc-mcp-core/commit/9becdfa8f2d67619ddf549c839a0aa929a9347a9))
* harden admin integrations ([f6eeb89](https://github.com/dcc-mcp/dcc-mcp-core/commit/f6eeb89dab1b7d125d614715da57c6812aaed6e9))
* harden cli gateway stop and local search ([42535ff](https://github.com/dcc-mcp/dcc-mcp-core/commit/42535ff69e63a7e91b29e002134e0da45a69cc73))
* honor no-log-file in idle smoke ([38e93ce](https://github.com/dcc-mcp/dcc-mcp-core/commit/38e93ce690780686d9423dbb30b78b7793916c3a)), closes [#1354](https://github.com/dcc-mcp/dcc-mcp-core/issues/1354)
* **host-rpc:** surface Maya sidecar bootstrap failures ([6d57980](https://github.com/dcc-mcp/dcc-mcp-core/commit/6d57980da53ec719b2d8a605977d3635aa32ff96))
* **http-server:** search_tools natural-language phrase matching ([#1667](https://github.com/dcc-mcp/dcc-mcp-core/issues/1667)) ([1b52d8c](https://github.com/dcc-mcp/dcc-mcp-core/commit/1b52d8c501d4f36c86d772c2447ca5be92228d06))
* improve gateway sidecar diagnostics ([1132c0c](https://github.com/dcc-mcp/dcc-mcp-core/commit/1132c0ca03a84cc97726882b07e5f4d1c645c592))
* increase probe wait time in flaky test to avoid macOS CI timing ([c228dee](https://github.com/dcc-mcp/dcc-mcp-core/commit/c228deedd7c6a7352465e7f4d5375b53f173e621))
* increase SSE notification budget for prompts watcher on slow CI runners ([#1542](https://github.com/dcc-mcp/dcc-mcp-core/issues/1542)) ([5e8c542](https://github.com/dcc-mcp/dcc-mcp-core/commit/5e8c542fedd1d84f0d49a773c7d4d0d0cef59ffa))
* increase timing tolerance in test_guardian_run_continues_after_exception for slow macOS ARM runners ([4875ec3](https://github.com/dcc-mcp/dcc-mcp-core/commit/4875ec35d1141b5174259dc70d118d7d987ea4b9))
* index loaded skill tools after gateway load ([99f95ee](https://github.com/dcc-mcp/dcc-mcp-core/commit/99f95eec7e6b807a05bc640127f79e5f6b2677b0))
* **install:** validate sidecar host rpc uri ([3f89104](https://github.com/dcc-mcp/dcc-mcp-core/commit/3f891045b7058450e8d5289eb51fcb0ea8317bb9))
* isolate sidecar early-exit log tails ([9e8f4b3](https://github.com/dcc-mcp/dcc-mcp-core/commit/9e8f4b322c930281ba41552ab8515ed490246b66))
* lint errors in Maya E2E tests (D403 docstring caps + F841 unused var) ([5f9e276](https://github.com/dcc-mcp/dcc-mcp-core/commit/5f9e27677ed398d485e7daf246d7cf561d036bbe))
* make --source exclusive and add icon to marketplace schema ([#1541](https://github.com/dcc-mcp/dcc-mcp-core/issues/1541)) ([5303b7d](https://github.com/dcc-mcp/dcc-mcp-core/commit/5303b7d262a4dcfa846cbd2c104090c211f6e691))
* make publish-clawhub-skills non-blocking in Release workflow ([7a51b8e](https://github.com/dcc-mcp/dcc-mcp-core/commit/7a51b8e1291ff5bab0eefecd3334d1dfe715df3e))
* make release webhook notification optional ([1c41f93](https://github.com/dcc-mcp/dcc-mcp-core/commit/1c41f93b95f730c562585170cef923a20feba1e3))
* **marketplace:** cargo fmt ([71d6474](https://github.com/dcc-mcp/dcc-mcp-core/commit/71d647477429ad0ab04f54703075e6f13e37b04f))
* **marketplace:** compact icon CSS to stay under 3000-line file-size gate ([bd09514](https://github.com/dcc-mcp/dcc-mcp-core/commit/bd09514a70068039edec3aa2b3cc41376e15cb17))
* **marketplace:** extract CSS to feature directory to stay under file-size gate ([9b1b933](https://github.com/dcc-mcp/dcc-mcp-core/commit/9b1b93388514ddd2b4a6cf50e8c11be18ecacc06))
* **marketplace:** remove blank lines to pass 3000-line file-size gate ([f5ae7d3](https://github.com/dcc-mcp/dcc-mcp-core/commit/f5ae7d3b44db7b77965e56138e332b2e9f4602b6))
* **marketplace:** switch to letter fallback when icon image fails to load ([0fe02ff](https://github.com/dcc-mcp/dcc-mcp-core/commit/0fe02ff92bce74a5cdd47f623017e9890776514b))
* **marketplace:** update packages from latest catalog refs ([5f0ae32](https://github.com/dcc-mcp/dcc-mcp-core/commit/5f0ae32ab4d6765d3b793ae8f6ea123df2c49f08))
* **mcp:** simplify exposed input schemas ([f34271a](https://github.com/dcc-mcp/dcc-mcp-core/commit/f34271afc95800868b47b6ec91a88660de5efa57))
* **models:** add branding/links/example_prompts to PyO3 constructor and regenerate stubs ([751af56](https://github.com/dcc-mcp/dcc-mcp-core/commit/751af5635aa1d8fe407d5570bae32e6680e43b2e))
* **p0-3:** add Python-side version-aware gateway takeover ([9dba781](https://github.com/dcc-mcp/dcc-mcp-core/commit/9dba7818050974e2752ec307f746e9448da57f4f))
* **p0-3:** resolve merge conflict and ruff format ([ab67a6c](https://github.com/dcc-mcp/dcc-mcp-core/commit/ab67a6c3f9ede5fe2dd6dca245d058b90e743c47))
* pivot install --execute to marketplace.json data source ([ef2167a](https://github.com/dcc-mcp/dcc-mcp-core/commit/ef2167adcc6d3433478d869b429844fb3235e3d1))
* polish admin select controls ([da47ddb](https://github.com/dcc-mcp/dcc-mcp-core/commit/da47ddbe76977bfaf62d7fd802f95a5a825b4696))
* preserve index on refresh_instance error, add regression test ([3f24ad8](https://github.com/dcc-mcp/dcc-mcp-core/commit/3f24ad8736efc28009a5f94af85d5e48c1e1df69)), closes [#1659](https://github.com/dcc-mcp/dcc-mcp-core/issues/1659)
* preserve sidecar discovery endpoint ([8ab5fdb](https://github.com/dcc-mcp/dcc-mcp-core/commit/8ab5fdbe4ff40c3e0ad4c6b66f527ce18cf79c5d))
* preserve wecom webhook on partial save ([e6a1b81](https://github.com/dcc-mcp/dcc-mcp-core/commit/e6a1b8188993f4c2515c49d1b212a8eef9e178f8))
* prevent silent embedded-fallback after gateway daemon ensure fails ([2713dc9](https://github.com/dcc-mcp/dcc-mcp-core/commit/2713dc9e56bfacc595e7c886dd177957f7bc2d13))
* **python:** add sidecar readiness verdict ([2c332e2](https://github.com/dcc-mcp/dcc-mcp-core/commit/2c332e2e6c8259a01829bbce24ac967e66ae2714))
* **python:** expose sidecar dispatch readiness ([53e5bff](https://github.com/dcc-mcp/dcc-mcp-core/commit/53e5bff48dd80ebbf9abaee2860ed376936b6fd7))
* **python:** probe sidecar tool readiness ([f914b6b](https://github.com/dcc-mcp/dcc-mcp-core/commit/f914b6bd6f48d08432b93a027c20efd9696b98ba))
* regenerate workspace-hack after bytemuck dependency introduction ([f45a2f4](https://github.com/dcc-mcp/dcc-mcp-core/commit/f45a2f45ea6aae3b8e232d69f0a497aaf5b04f2c))
* **release:** isolate release workflow concurrency from other CI ([5c90582](https://github.com/dcc-mcp/dcc-mcp-core/commit/5c905826a93962057172add6b5af4f8f48a30ea3))
* **release:** retry flaky admin-ui npm ci on release builds ([#1486](https://github.com/dcc-mcp/dcc-mcp-core/issues/1486)) ([3caf087](https://github.com/dcc-mcp/dcc-mcp-core/commit/3caf087c2a57371c299a021c7f3357d83e788606))
* **release:** upload dcc_mcp_core wheels to GitHub Release per-platform ([e41da9a](https://github.com/dcc-mcp/dcc-mcp-core/commit/e41da9a5675cb80f07c8d6cfedc1e28df93d4dde))
* remove deprecated Python::is_initialized() for pyo3 0.28 compat ([37ffa00](https://github.com/dcc-mcp/dcc-mcp-core/commit/37ffa00f5c8bb740c144ffe39ca13bf48df2cddc))
* remove openssl from server binary graph ([6d095b3](https://github.com/dcc-mcp/dcc-mcp-core/commit/6d095b31f0eaea8ca1b3bf88289326e0b8e5725a))
* remove stale args.* references in dcc-diagnostics kwargs path ([6442639](https://github.com/dcc-mcp/dcc-mcp-core/commit/64426390587cca1d79972ed7834d8569bf4e9fda))
* remove trailing blank line to satisfy cargo fmt ([2329217](https://github.com/dcc-mcp/dcc-mcp-core/commit/23292172012d70ae483fa2e9ca16c48474bcdeaa))
* remove trailing semicolon in AlreadyExists branch to return Result ([678c1cc](https://github.com/dcc-mcp/dcc-mcp-core/commit/678c1cc35e74010f22f92263f0e5b862d008702c))
* replace _wait_until busy-polling with Event.wait() in guardian test ([0fa1bbe](https://github.com/dcc-mcp/dcc-mcp-core/commit/0fa1bbebed4b957244018607badb026bb6b13a6a))
* replace unwrap_or_else closure with block in sidecar launcher ([3e0e75a](https://github.com/dcc-mcp/dcc-mcp-core/commit/3e0e75a74c4930e1d6e3a253faed351b3f05cb29))
* replace unwrap_or_else with unwrap_or in gateway_launch_lock_stale_after ([84df1dc](https://github.com/dcc-mcp/dcc-mcp-core/commit/84df1dc352992ae22e0d9a6fa6ac335d454f0470))
* resolve admin ci failures ([5d333f9](https://github.com/dcc-mcp/dcc-mcp-core/commit/5d333f99eb37e19e435474e40483b726b980ff68))
* resolve clippy warnings — unneeded return and unnecessary closure ([20e0754](https://github.com/dcc-mcp/dcc-mcp-core/commit/20e07542abbc74d6fef6e183db0bef51c7639090))
* resolve E402 lint errors by moving imports to top of file ([f41d82a](https://github.com/dcc-mcp/dcc-mcp-core/commit/f41d82a7e9ef5431dd81c8d24a84b1f12c2c493a))
* resolve flaky gateway guardian tests ([aaeccfe](https://github.com/dcc-mcp/dcc-mcp-core/commit/aaeccfee5c5af2a9a53c2211bbac5afb749f5c8d))
* resolve packaged gateway binary ([1219662](https://github.com/dcc-mcp/dcc-mcp-core/commit/12196629b91e448c63d6c282d165ee0fbfdb750e))
* resolve ruff lint issues in asset_import.py ([c67f7b5](https://github.com/dcc-mcp/dcc-mcp-core/commit/c67f7b580fcaad19b70cea56f9281efa7f1c9860))
* resolve ruff lint issues in test_asset_import_contract.py ([ed36fa2](https://github.com/dcc-mcp/dcc-mcp-core/commit/ed36fa2dec51e60894e33110998dbd9c9d749b49))
* resolve ruff lint issues in update manifest generator ([205918a](https://github.com/dcc-mcp/dcc-mcp-core/commit/205918a40df4e72afd6265fb829015d06b2e0cb6))
* resolve ruff lint violations in _registration.py ([02ebc11](https://github.com/dcc-mcp/dcc-mcp-core/commit/02ebc115b9a1b02de1c0bd59f0be9afb00113b97))
* resolve ruff lint/format errors in _registration.py ([20c4818](https://github.com/dcc-mcp/dcc-mcp-core/commit/20c48182f8bb552ca1429142cb71427230eebc55))
* resolve TypeScript and markdown lint issues ([bc7d357](https://github.com/dcc-mcp/dcc-mcp-core/commit/bc7d3570cbf16d15d98c777520c52d9c9d894450))
* restore return keyword in lock-acquire double-check block ([74e326f](https://github.com/dcc-mcp/dcc-mcp-core/commit/74e326f919a930b4f84d804b9f99f381ff45fc28))
* restore return keywords for early health-check returns ([cc4bbd3](https://github.com/dcc-mcp/dcc-mcp-core/commit/cc4bbd338001add4885b4d1e313c732c17db0a14))
* restore version to 0.18.15 (x-release-please-version) ([fa920f3](https://github.com/dcc-mcp/dcc-mcp-core/commit/fa920f3dbb2da7af90c6ee02221d99cc9c92b3e6))
* ruff D413 - blank line after Returns section content ([67752cd](https://github.com/dcc-mcp/dcc-mcp-core/commit/67752cda31d7712a79e1ef979da10a8365a22bf1))
* ruff format asset_import.py ([d613719](https://github.com/dcc-mcp/dcc-mcp-core/commit/d6137191abed8982c3b036aeec7429d3c2660e6a))
* ruff format on Maya E2E tests ([674e675](https://github.com/dcc-mcp/dcc-mcp-core/commit/674e675abc78bf6c6096c905105897796ff9c531))
* run ruff format on test_gateway_facade_aggregation.py ([0f6cf17](https://github.com/dcc-mcp/dcc-mcp-core/commit/0f6cf1777032ef474892a3d1087c9168d7fa482c))
* rustfmt, rename push_arg, remove restart_spawn_fresh, add pre-push fmt ([7ae2bf6](https://github.com/dcc-mcp/dcc-mcp-core/commit/7ae2bf6a084d384ae19c96cd2372d0766fdf0694))
* **semantic:** align embedder with pyo3 0.28 and fastembed 5 APIs ([0b50741](https://github.com/dcc-mcp/dcc-mcp-core/commit/0b50741a2a7dc852da6cc5414ae3a4b21e71654e))
* **semantic:** switch fastembed to rustls and ship aarch64-only macOS wheel ([a939348](https://github.com/dcc-mcp/dcc-mcp-core/commit/a939348b8ec15f3ae5ac4c56f8119972500fea8c))
* **server:** expose sidecar diagnostics listener ([3e382c4](https://github.com/dcc-mcp/dcc-mcp-core/commit/3e382c4dd1b2017d250fcc57a7b9fefd183a1aa6))
* **server:** expose sidecar dispatch readiness ([6eb5ef2](https://github.com/dcc-mcp/dcc-mcp-core/commit/6eb5ef293076c5be6e5e21acda9e617244972ffb))
* **server:** guard auto gateway daemon ([7d12b39](https://github.com/dcc-mcp/dcc-mcp-core/commit/7d12b3927745a66c3f127936ac77ddf209d79787))
* **server:** guard sidecar gateway daemon ([b01e336](https://github.com/dcc-mcp/dcc-mcp-core/commit/b01e336bd9371472433681a779e8f951f61a6f9f))
* **server:** guard translate gateway daemon ([ef1ae25](https://github.com/dcc-mcp/dcc-mcp-core/commit/ef1ae258299765977dba134972ccaa6890699adb))
* **server:** recover stale gateway launch locks ([d3456d0](https://github.com/dcc-mcp/dcc-mcp-core/commit/d3456d0636db493e3399ace2192fc5ac44eb0d7f))
* **server:** report daemon gateway diagnostic modes ([80523bc](https://github.com/dcc-mcp/dcc-mcp-core/commit/80523bc3a25c98fea9e417b10ef6168845b2a22b))
* **server:** restart gateway daemon from Python guardian ([#1439](https://github.com/dcc-mcp/dcc-mcp-core/issues/1439)) ([d347054](https://github.com/dcc-mcp/dcc-mcp-core/commit/d3470543ab051fa8897c55d2c9811b624eb82584))
* set DCC_MCP_MARKETPLACE_NO_DEFAULT_SOURCES=1 in ScopedMarketplaceInstallRoot ([30d2186](https://github.com/dcc-mcp/dcc-mcp-core/commit/30d21862c02d332fee77199593413a69a566de5b))
* **sidecar:** abort old guardian before replacing in watchdog restart ([4df37b9](https://github.com/dcc-mcp/dcc-mcp-core/commit/4df37b975ab2d7663ead514ff2735eaadf278a94))
* **sidecar:** keep stub host rpc non-routable ([0e439ad](https://github.com/dcc-mcp/dcc-mcp-core/commit/0e439ad834b972f5b25e1adbe6cd7c06bc543b16))
* **sidecar:** make launch readiness explicit ([0266bad](https://github.com/dcc-mcp/dcc-mcp-core/commit/0266bad0b05dc763c262a0ace7a72a404d740638))
* **sidecar:** reject ambiguous readiness selectors ([a265748](https://github.com/dcc-mcp/dcc-mcp-core/commit/a265748e7121d2260bcff13408606ba8a5bf9588))
* **sidecar:** respect legacy gateway mode ([79bc6d7](https://github.com/dcc-mcp/dcc-mcp-core/commit/79bc6d78207b743e46d0398d1ffd851e1d859210))
* **skill-rest:** generate inputSchema from Python signatures in describe for unloaded skills ([62a8e85](https://github.com/dcc-mcp/dcc-mcp-core/commit/62a8e851b7049558406907ecf5ad7cb682026d26))
* **skills:** eliminate env var race condition in resolve_registry_dcc_type tests ([4b32a4a](https://github.com/dcc-mcp/dcc-mcp-core/commit/4b32a4ae5e96497a55091a00f25d7c01daba5ffb))
* **skills:** eliminate env var race condition in resolve_registry_dcc_type tests ([881e479](https://github.com/dcc-mcp/dcc-mcp-core/commit/881e479f6394f2dbb501620ce74bedc606590d13))
* **skills:** embed generate_input_schema.py into binary to fix schema gen in production ([#1687](https://github.com/dcc-mcp/dcc-mcp-core/issues/1687)) ([89a2517](https://github.com/dcc-mcp/dcc-mcp-core/commit/89a25171fa73174c6d3899aca3bf6ebab5d3421c))
* **skills:** fix flaky embedded helper fallback test by removing global state manipulation ([dc83a9c](https://github.com/dcc-mcp/dcc-mcp-core/commit/dc83a9c7c1c11c3d42811eda5e294eec64343b8e))
* **skills:** pass skills to register_recipes_tools in builtin registration ([ed6fde8](https://github.com/dcc-mcp/dcc-mcp-core/commit/ed6fde881f2d264a83f21063a8297ff17bb5cb56))
* **skills:** remove unused find_helper_script that caused compilation error ([c9d204d](https://github.com/dcc-mcp/dcc-mcp-core/commit/c9d204da52ffdbc79203cdbc896b63175a09aab4))
* skip guardian test on Windows + py3.14 to unblock PR ([e4f9af6](https://github.com/dcc-mcp/dcc-mcp-core/commit/e4f9af6329fa353422abe94f08b58bfbae867542))
* sort imports in clawhub_sync.py (ruff I001) ([7abbac8](https://github.com/dcc-mcp/dcc-mcp-core/commit/7abbac81deffca943b0229de5e074e05128642e4))
* split admin integration module ([869dd70](https://github.com/dcc-mcp/dcc-mcp-core/commit/869dd70e092da367f78985c7edcd3308db4a9879))
* stabilize cli registry e2e ([2ee36e2](https://github.com/dcc-mcp/dcc-mcp-core/commit/2ee36e2a19f349fa15b8b75d3a1516e578514b4c))
* support nested marketplace skills ([3abf56f](https://github.com/dcc-mcp/dcc-mcp-core/commit/3abf56f1d7ef3f7b95549415e820af04ff3a3735))
* suppress clippy too_many_arguments on refresh_instance (8 params) ([5f170ae](https://github.com/dcc-mcp/dcc-mcp-core/commit/5f170aeeadc700d66239e61877a8183cbaaabdff))
* surface gateway load skill backend failures ([be08d4d](https://github.com/dcc-mcp/dcc-mcp-core/commit/be08d4d11ef74fc82826331cb25aeab6653463b9))
* surface sidecar early-exit diagnostics ([22f1ecb](https://github.com/dcc-mcp/dcc-mcp-core/commit/22f1ecb9ef4a0d7c099008f2500c3a3de110205f))
* sync release metadata for 0.18.0 ([198e832](https://github.com/dcc-mcp/dcc-mcp-core/commit/198e8320eae65fba9e8a115b873bc24e96ed0d07))
* **test:** replace fixed sleep with polling in facade_cluster fixture ([23fca16](https://github.com/dcc-mcp/dcc-mcp-core/commit/23fca1696777102760f0628619e49a970928210b))
* **test:** set is_gateway=True in crash_recovery_loop on_promote callback ([eddd785](https://github.com/dcc-mcp/dcc-mcp-core/commit/eddd785558b62f84a3a201fbf00978e569fd424b))
* **tests:** remaining exact-name queries for layer=example bypass ([ebe799f](https://github.com/dcc-mcp/dcc-mcp-core/commit/ebe799f1f110f8c31552e91758084a782f93baa0))
* **tests:** use exact skill names to bypass layer=example exclusion ([7adcdd5](https://github.com/dcc-mcp/dcc-mcp-core/commit/7adcdd5e9875897f8cfc8ba8943a0763217a5343))
* tolerate versioned ClawHub duplicate error messages ([e8b5766](https://github.com/dcc-mcp/dcc-mcp-core/commit/e8b57663e2f2d18d156bcf2cf9a17e47ced94f15))
* tolerate versioned ClawHub duplicate errors ([13c4b74](https://github.com/dcc-mcp/dcc-mcp-core/commit/13c4b7480987de25692b7d866a89f24e4461b9c0))
* **transport:** add dual-format SystemTime deserializer and defensive parse fallback ([91c472a](https://github.com/dcc-mcp/dcc-mcp-core/commit/91c472a3fa003f0b16f668d1f9c5ddf5608f690e))
* unify concurrent gateway ensure timeout and lock-loser wait logic ([859c362](https://github.com/dcc-mcp/dcc-mcp-core/commit/859c362636fb68b3f345023a2879a45f923fe60a))
* update bundled catalog test to use photoshop (infra-only, no install metadata) ([2a772cd](https://github.com/dcc-mcp/dcc-mcp-core/commit/2a772cd4b874566b20eefb14c247d6d17f04ecbc))
* update test assertion from clawhub to openclaw ([1ad75f1](https://github.com/dcc-mcp/dcc-mcp-core/commit/1ad75f1b28fe3bf8af8aacc1f83bb4992a9bc5d8))
* **updater, gateway, cli:** address PR review issues ([c7b1c85](https://github.com/dcc-mcp/dcc-mcp-core/commit/c7b1c854975ce27551e331afc24af42cc1cac983))
* use instance server version for updates ([14c6d4b](https://github.com/dcc-mcp/dcc-mcp-core/commit/14c6d4b20a6099c91b406679012de0077dc8182f))
* validate sidecar instance ids ([ab31799](https://github.com/dcc-mcp/dcc-mcp-core/commit/ab317994211e4904aaa2d6884b6975ea33f1560a))


### Code Refactoring

* add explicit server run modes ([c3ba37e](https://github.com/dcc-mcp/dcc-mcp-core/commit/c3ba37ee027bf775bf6f4422b7ce9196391bdcf4)), closes [#1360](https://github.com/dcc-mcp/dcc-mcp-core/issues/1360)
* **admin-ui:** replace manual fetch/polling with @tanstack/react-query ([f7c2953](https://github.com/dcc-mcp/dcc-mcp-core/commit/f7c2953095c0c130b09f0e9889c39269f1dcba9a))
* **capability:** consolidate dual compute_fingerprint into gateway-core ([0a3c2a7](https://github.com/dcc-mcp/dcc-mcp-core/commit/0a3c2a793acace07147dbcc04ef16488e1126713))
* **core:** extract shared _lazy.py helper for lazy-import scaffolding ([777cb3b](https://github.com/dcc-mcp/dcc-mcp-core/commit/777cb3b0895e66a72db20e83abdefcebc222bb1c))
* **core:** split DccServerBase into 4 seam controllers (PIP-688) ([a31051e](https://github.com/dcc-mcp/dcc-mcp-core/commit/a31051e1495c5490f7572a9337addbf4523a4c81))
* **gateway-core:** sink namespace pure helpers ([#1368](https://github.com/dcc-mcp/dcc-mcp-core/issues/1368)) ([b26e56a](https://github.com/dcc-mcp/dcc-mcp-core/commit/b26e56ad37646b66398623a535ddc8a2a397fe62))
* **gateway:** drop `gateway::namespace` facade ([#1368](https://github.com/dcc-mcp/dcc-mcp-core/issues/1368)) ([de0017c](https://github.com/dcc-mcp/dcc-mcp-core/commit/de0017c0c7e0021e20a4faf2fcb1e502a0a30b2b))
* **gateway:** formalise standalone gateway daemon mode ([#1358](https://github.com/dcc-mcp/dcc-mcp-core/issues/1358)) ([20aab13](https://github.com/dcc-mcp/dcc-mcp-core/commit/20aab1303919ffd72457637b093fe28493b76e24))
* **http:** gate auto-gateway bootstrap behind a cargo feature ([#1357](https://github.com/dcc-mcp/dcc-mcp-core/issues/1357)) ([f9c3308](https://github.com/dcc-mcp/dcc-mcp-core/commit/f9c3308cda763da0bc73ffd4d9c91c481e2203d3))
* Phase 1 unsafe cleanup — shared test-utils crate, bytemuck shm, safe pyo3 API ([9965a15](https://github.com/dcc-mcp/dcc-mcp-core/commit/9965a152cb56fe43fc6e0ce67b99c9e8c0e0eac7))
* Phase 2 unsafe cleanup — Send/Sync derive, EnvVarsGuard shared ([#1660](https://github.com/dcc-mcp/dcc-mcp-core/issues/1660)) ([106095e](https://github.com/dcc-mcp/dcc-mcp-core/commit/106095ee84032f69fe487c4a38e2b92f85cae772))
* **server:** add Cargo features for composition binary ([#1359](https://github.com/dcc-mcp/dcc-mcp-core/issues/1359)) ([b40e309](https://github.com/dcc-mcp/dcc-mcp-core/commit/b40e309fdc70fa6859b50b5444c0b5e2e8a72a28))
* **sidecar:** split gateway daemon modules ([97aca90](https://github.com/dcc-mcp/dcc-mcp-core/commit/97aca90695ae7ed6da36d1328de2ea44c7bfb13f))
* **sidecar:** split MCP listener modules ([3260f9b](https://github.com/dcc-mcp/dcc-mcp-core/commit/3260f9b7494db54654ea30ed7534a3256357c598))
* **sidecar:** split runtime modules ([aec4e98](https://github.com/dcc-mcp/dcc-mcp-core/commit/aec4e98cc72c389cb0e7a42f800c714e24f9d509))
* **sidecar:** split sidecar runtime crate ([a26d38f](https://github.com/dcc-mcp/dcc-mcp-core/commit/a26d38ffb3ccf024a2ba57180442908bdc8cfb1d))
* **skills:** drop example skills, lower thin-harness rank ([#1398](https://github.com/dcc-mcp/dcc-mcp-core/issues/1398)) ([00eb631](https://github.com/dcc-mcp/dcc-mcp-core/commit/00eb631343fb24002f0c169ddf863bdce4ded4f5))
* split oversized cleanup targets ([1dd7d32](https://github.com/dcc-mcp/dcc-mcp-core/commit/1dd7d32329b5384bd4f2ef7c968b5d77491fe37c))


### Documentation

* add adapter release train onboarding docs ([362e1cc](https://github.com/dcc-mcp/dcc-mcp-core/commit/362e1ccc9da696974bf1a15c4ba350d08ff53cc2))
* add Admin Integrations configuration docs (PIP-550) ([f804a52](https://github.com/dcc-mcp/dcc-mcp-core/commit/f804a52deb1d83757ca4d4bd3f56f6945f8ecde7))
* add Autodesk Product Help catalog connector ([46b20f0](https://github.com/dcc-mcp/dcc-mcp-core/commit/46b20f076bcd519a59fc4a1c31b13d356c385a0f))
* add built-in skills, Qt inspector, capability graph, dispatch readiness documentation ([f5cdd1e](https://github.com/dcc-mcp/dcc-mcp-core/commit/f5cdd1e3c5f72c31e097fd930cd5d91140462087))
* add DCC MCP brand logo ([7d80799](https://github.com/dcc-mcp/dcc-mcp-core/commit/7d807993fb6ec7203655306f71dc9d0649bca67a))
* add FPT to compatibility matrix, mark pending adapter tags ([27120e0](https://github.com/dcc-mcp/dcc-mcp-core/commit/27120e03aaa14e334220206aff2cf9f5e95638f1))
* add gateway ensure lifecycle commands, marketplace source management, and AGENTS marketplace skill references ([d452f7d](https://github.com/dcc-mcp/dcc-mcp-core/commit/d452f7d904f33eefe83ae8478c5f11bd0de8fb70))
* add lifecycle hooks, agent memory, built-in skills, and readiness documentation ([#1427](https://github.com/dcc-mcp/dcc-mcp-core/issues/1427)) ([9a1efe7](https://github.com/dcc-mcp/dcc-mcp-core/commit/9a1efe7376aa3b82f1f8b4fa3924e6cfec2f47e4))
* add Marketplace Panel and Admin Workflow sections to docs ([632d281](https://github.com/dcc-mcp/dcc-mcp-core/commit/632d281aa4c4d20541e0aed045b592131eb68735))
* add marketplace, analytics dashboard, and sentry monitoring docs ([1c3c707](https://github.com/dcc-mcp/dcc-mcp-core/commit/1c3c7070e33ac9747cc438e2fc8c42ac4eabd58e))
* add migration guide and topology recipes ([#1366](https://github.com/dcc-mcp/dcc-mcp-core/issues/1366)) ([104e96a](https://github.com/dcc-mcp/dcc-mcp-core/commit/104e96a1579b5e901cf6b7954143cfe9fecb8e9a))
* add skill persistence, semantic search, lifecycle hooks, and agent memory documentation ([f4bb60e](https://github.com/dcc-mcp/dcc-mcp-core/commit/f4bb60e488836e5824eb8e5eea0c36a9f556550c))
* **adr:** add ADR-010 MCP 2026-07-28 dual-protocol migration strategy ([3a7c655](https://github.com/dcc-mcp/dcc-mcp-core/commit/3a7c655cb56d38473e368534353e6fc1c63e0feb))
* **agents:** note OnnxEmbedder env-var overrides in decision table ([b316883](https://github.com/dcc-mcp/dcc-mcp-core/commit/b31688391eb31a91dfa36b4557ba890c346f1fa1))
* align CLI references to CLI-first narrative with Python fallback positioning ([60328ec](https://github.com/dcc-mcp/dcc-mcp-core/commit/60328ec2bbfbd2bce981914ce25352be1aa1b71d))
* **catalog:** update photoshop adapter entry with setup tag and installer docs URL ([c40e19a](https://github.com/dcc-mcp/dcc-mcp-core/commit/c40e19ae7e0daa6bbb8dce74d9e431a5eaafb95c))
* document auto-update, --restart, install --execute, gateway-ensure crate, and marketplace slide-out ([25d0180](https://github.com/dcc-mcp/dcc-mcp-core/commit/25d01803f8598af5781ff7429d3c400743502e86))
* document CLI standalone ZIP bundle ([#1651](https://github.com/dcc-mcp/dcc-mcp-core/issues/1651) follow-up) ([db49b97](https://github.com/dcc-mcp/dcc-mcp-core/commit/db49b9736026bc651e2daf8fdc83fcff579adb3e))
* document search_tools multi-word phrase matching ([5fc6d27](https://github.com/dcc-mcp/dcc-mcp-core/commit/5fc6d2750e68f76ca88a1b1c5b758788079c6ed6))
* fix dead link in Chinese skill-maintenance translation ([5143abe](https://github.com/dcc-mcp/dcc-mcp-core/commit/5143abeb7d29561cbf37d8e6e8b61aa2555f4ca3))
* fix stale package counts, Python version range, and version examples ([#1688](https://github.com/dcc-mcp/dcc-mcp-core/issues/1688)) ([63fd7fd](https://github.com/dcc-mcp/dcc-mcp-core/commit/63fd7fd1e437b2f6943340f50417d723780d6544))
* **gateway:** add Maya rendering intent routing table to agent-workflows guide ([7cf17ac](https://github.com/dcc-mcp/dcc-mcp-core/commit/7cf17acbdcae56c7f56aac8ec367f76414d14398))
* **gateway:** clarify daemon-backed auto mode ([23190b1](https://github.com/dcc-mcp/dcc-mcp-core/commit/23190b154f6b8481e3d165404ded3caa4502adcc))
* **gateway:** define daemon runtime vocabulary ([60d1882](https://github.com/dcc-mcp/dcc-mcp-core/commit/60d1882515c0eeb0bc452d61c1d1e0183a45fd61))
* **gateway:** document runtime supervisor topology + add cross-DCC regression tests ([f1cfd04](https://github.com/dcc-mcp/dcc-mcp-core/commit/f1cfd04d3b1568690c45715b56c80d5cc2756200))
* **gateway:** use dash bullets to match file style ([#1358](https://github.com/dcc-mcp/dcc-mcp-core/issues/1358)) ([82ce06e](https://github.com/dcc-mcp/dcc-mcp-core/commit/82ce06ec9d8a207665055508e212f5ec1bcc5fb1))
* guide skill dependency authoring ([7a8a3c0](https://github.com/dcc-mcp/dcc-mcp-core/commit/7a8a3c0017c5a65a0b74f59f8cd6262eb1955e23))
* **release:** document 0.18.0 minor rationale ([f5f7386](https://github.com/dcc-mcp/dcc-mcp-core/commit/f5f7386d424e9ed384d4b06758a73c20a72179d9))
* **server:** document daemon-backed gateway default mode ([daabc99](https://github.com/dcc-mcp/dcc-mcp-core/commit/daabc99fdbca639ce902676b72b8f5099fdecd2a))
* **skills-creator:** correct tags_any/dcc_types as planned fields, not current ([d5be4eb](https://github.com/dcc-mcp/dcc-mcp-core/commit/d5be4eba6ecff0790c240e3da94e8eb0ba85d2ba))
* **skills-creator:** document gateway-facing tag taxonomy ([73f7714](https://github.com/dcc-mcp/dcc-mcp-core/commit/73f7714a4af975330541f896f724f8060668607f))
* sync README_zh bundled skills table and remove stale pip install -e . hints ([#1690](https://github.com/dcc-mcp/dcc-mcp-core/issues/1690)) ([ba97f51](https://github.com/dcc-mcp/dcc-mcp-core/commit/ba97f51120fcd5df01736582a732c99179e120be))
* update cli-reference.md with outdated/update commands ([e93421e](https://github.com/dcc-mcp/dcc-mcp-core/commit/e93421e1d701cbae94a76d9de4f7a7f3cb225379))
* update sidebar navigation and add missing Chinese translations ([f01ee2e](https://github.com/dcc-mcp/dcc-mcp-core/commit/f01ee2e41178aad6866d70d52de23d23ae10fabc))
