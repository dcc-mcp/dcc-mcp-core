...
mod tests {
    ...
    fn ui_control_json_is_exposed_as_structured_admin_log() {
        let line = r#"2026-07-20T12:00:00.000Z WARN dcc_mcp_core.ui_control.audit: {"action":"set_text","action_id":"action:abc","artifacts":[{"uri":"artefact://sha256/abc","display_name":"ui-control-snapshot-lookdev-snapshot.png"}],"dcc_type":"unreal","detail":"backend=windows-uia action=set_text session=lookdev error=policy_disabled","error":"policy_disabled","event":"ui_control_operation","message":"DCC UI Control act rejected","state_delta":{"change_count":1,"paths":["/focus"]},"success":false,"tool":"ui_control__act"}"#;
