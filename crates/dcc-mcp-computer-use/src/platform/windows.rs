...
use windows::Win32::Foundation::{
    CloseHandle, HANDLE, HWND, LPARAM, POINT, RECT, WAIT_ABANDONED,
...
pub(super) type OverlayGeometry = (i32, i32, i32, i32);
pub(super) type CornerGeometries = Vec<(OverlayGeometry, u8, bool)>;
