...
// Re-export Windows types needed by sub-module test code (input_tests.rs)
// that uses `use super::*;` — these were in scope before extracting
// overlay_render.rs and must remain reachable through the parent module.
pub(super) use windows::Win32::Graphics::Gdi::{DeleteObject, HGDIOBJ, RGN_ERROR};
pub(super) use windows::Win32::System::LibraryLoader::GetModuleHandleW;
pub(super) use windows::Win32::UI::WindowsAndMessaging::{
    GetClassInfoW, WNDCLASSW, WS_EX_NOACTIVATE, WTS_CONSOLE_CONNECT, WTS_CONSOLE_DISCONNECT,
