"""Consolidated: the canonical Qt dispatcher source lives at python/dcc_mcp_core/host/qt_dispatcher.py.

The Rust crate ``dcc-mcp-host-rpc`` embeds the canonical source
directly via::

    include_str!("../../../python/dcc_mcp_core/host/qt_dispatcher.py")
...
the real implementation, see ``python/dcc_mcp_core/host/qt_dispatcher.py``.
