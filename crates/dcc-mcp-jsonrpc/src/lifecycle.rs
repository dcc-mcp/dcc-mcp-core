...
// Types for `server/discover` live in `discover.rs` (`ServerDiscoverResult`,
// `DiscoverCapabilities`) to avoid duplication with lifecycle types.
// See review: Linus NACK PR #1730, task #1.
