...
| OBS Studio | [dcc-mcp-obs](https://github.com/dcc-mcp/dcc-mcp-obs) | 1.4.0 | >=0.20.14,<1.0.0 | 28+ | In-process native plugin + authenticated loopback WebSocket sidecar | 2026-09 |
