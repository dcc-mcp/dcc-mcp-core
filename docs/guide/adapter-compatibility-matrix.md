...
| Blender | [dcc-mcp-blender](https://github.com/dcc-mcp/dcc-mcp-blender) | ⏳ pending | >=0.17.0,<1.0.0 | 3.6+ | Background blocking dispatcher | 2026-04 |
| Houdini | [dcc-mcp-houdini](https://github.com/dcc-mcp/dcc-mcp-houdini) | ⏳ pending | >=0.17.0,<1.0.0 | 20.5+ | Event-loop callback | 2026-04 |
