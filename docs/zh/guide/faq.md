...
核心库要求 Python 3.8+。纯 Python 模块语法兼容 Python 3.7（Maya 2022）。详见 [Maya 2022 支持策略](/zh/guide/maya2022-support)。
...
Python 3.8–3.14 在 CI 中全部测试。使用 `abi3-py38` 构建 wheel 以最大化兼容性。Python 3.7 语法兼容性（Maya 2022）单独验证。
