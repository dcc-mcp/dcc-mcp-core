...
export function NavIcon({ panel }: { panel: Panel }) {
  const icons: Record<Panel, string[]> = {
    ...
    memory: ['M5 7c0-2 14-2 14 0s-14 2-14 0', 'M5 7v10c0 2 14 2 14 0V7', 'M5 12c0 2 14 2 14 0'],
    ...
    sessions: ['M7 5h10l3 3v11H7z', 'M3 8h2l1 8h12l1 4H7z', 'M10 13h6', 'M10 16h5', 'M8 10h.01'],
    reliability: ['M12 2l3 9h5l-4 3 1.5 7L12 17l-5.5 4L8 14l-4-3h5z', 'M12 8v4', 'M12 16h.01'],
  };
  return (
